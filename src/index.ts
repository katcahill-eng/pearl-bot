...
(async () => {
  await initDb();
  await app.start();
  console.log(`⚡ MarcomsBot is running in socket mode (BUILD 2026-02-20T1200 — brief-template+naming-convention+mkt-number) instance=${getInstanceId().substring(0, 8)}`);
